...
import { Calendar, Users, Camera, Clock, MapPin } from "lucide-react"
...
export default async function ScubaDiscoveryPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const t = await getPageDictionary("scuba-discovery", locale) as Record<string, any>
    ...
    <>
      <Breadcrumbs
        ...
        items={[
          ...
          { label: getPageSeo("scubaDiscovery", locale).title },
        ]}
      />
    <main className="flex-1">
      ...
      <section className="relative">
        <div className="absolute inset-0 -z-10">
          <Image src="/snorkeling-coral-reef.jpg" alt={t.hero.image_alt} fill priority className="object-cover" />
